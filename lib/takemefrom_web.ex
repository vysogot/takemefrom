defmodule TakemefromWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: TakemefromWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/takemefrom_web/templates",
        namespace: TakemefromWeb
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {TakemefromWeb.LayoutView, "live.html"}
